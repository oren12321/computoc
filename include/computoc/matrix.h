...
namespace computoc {
    namespace details {
        ...
        template <typename T>
        using Matrix_buffer = memoc::Buffer<T, memoc::Fallback_allocator<
        ...
        template <typename T, typename Internal_buffer, memoc::Allocator Internal_allocator>
        ...
        /*
        template <Numeric T, typename Internal_buffer = Matrix_buffer<T>>
        class Matrix {
        public:
        ...
        template <Numeric T, typename Internal_buffer>
